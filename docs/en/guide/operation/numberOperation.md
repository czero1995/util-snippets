...
`Resolve 0.1 + 0.2 = 0.0.30000000000000004`
...
/**
 * Example：plus(0.1,0.2) = 0.3 、plus(0.1,0.2, ...more)
 * Example：subtract(0.3,0.2) = 0.1 、subtract(0.3,0.2, ...more)
 * Example：multiply(0.1,0.2) = 0.02 、multiply(0.1,0.2, ...more)
 * Example：divide(0.3,0.1) = 3 、 divide(0.1,0.2, ...more)
 */
